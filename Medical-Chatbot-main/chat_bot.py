...
def getInfo():
    ...
    while True:
        try:
            ...
            readn("Please enter a valid age.")
            print("Invalid input. Please enter a number.")

    readn("please enter your gender")
    print("\nYour Gender (Male/Female/Other)? \t", end="-> ")
    gender = input("")

    readn(f"Age {age} and gender {gender} recorded.")
...
print("----------------------------------------------------------------------------------------")
print("Your diagnosis is completed. Please take the above measures and consult a specialist.")